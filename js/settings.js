...
function handleChatBackgroundUpload(e){
...
function openSettings(){
  ...
  document.getElementById('setChatBackground').value=s.chatBackground||'mist';
...
function saveSettingsPage(){
  ...
  saveSettings();applyCustomCSS();applyTypography();applyChatBackground();updateModelTag();updateHeaderTitle();updateInputHint();updateGlobalHeader();
...
async function handleBackupImport(e){
  ...
  renderChatList();renderMessages();applyCustomCSS();applyTypography();applyChatBackground();updateModelTag();
...
async function init(){
  try{
    ...
    renderChatList();renderMessages();applyCustomCSS();applyTypography();applyChatBackground();updateModelTag();updateHeaderTitle();updateInputHint();updateSendBtn();
